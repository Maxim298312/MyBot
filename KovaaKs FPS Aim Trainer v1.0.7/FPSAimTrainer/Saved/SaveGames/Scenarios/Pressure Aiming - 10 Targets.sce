Name=Pressure Aiming - 10 Targets
PlayerCharacters=Balloon Shooter
BotCharacters=Balloon.bot
IsChallenge=true
Timelimit=120.0
PlayerProfile=Balloon Shooter
AddedBots=Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot;Balloon.bot
PlayerMaxLives=0
...
BlockFCT=true
Description=Manage bombarding targets before they despawn or collide. A test of flick reflex, multitasking, and depth perception.
GameVersion=1.0.5
...
JetpackMaxZVelocity=400.0
JetpackAirControlWithThrust=1.0
AbilityProfileNames=Approach.abilmov;Depart.abilmov;Damage Self Only.abilwep;Damage Player and Self.abilwep
HideWeapon=true
AerialFriction=0.0
StrafeSpeedMult=1.0
BackSpeedMult=1.0
...
DelayAfterUse=0.0
FullyAuto=true
WeaponProfile=Damage Self Only
...
AIMinTargHealth=0.0
AIMaxTargHealth=100.0
AIMinTargDist=4000.0
AIMaxTargDist=7000.0
AIMaxTargFOV=10.0
AIDamageReaction=false
AIDamageReactionIgnoreChance=0.0
AIDamageReactionMinDelay=0.125
...
[Weapon Ability Profile]
Name=Damage Player and Self
MaxCharges=1.0
ChargeTimer=1.0
ChargesRefundedOnKill=0.0
DelayAfterUse=0.0
FullyAuto=true
WeaponProfile=Mutual Annihilation
BlockAttackTimer=0.0
AbilityBlockedWhenAttacking=false
AmmoPerShot=0
AIUseInCombat=true
...
AIReuseTimer=1.0
AIMinSelfHealth=0.0
AIMaxSelfHealth=51.0
AIMinTargHealth=0.0
AIMaxTargHealth=100.0
AIMinTargDist=7000.0
